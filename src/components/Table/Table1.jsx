...
const Table1 = ({
  ...
  return (
    ...
    {/* Set a max height for the parent div */}
    <div className={classNames('overflow-auto max-h-[400px]', className)} style={{ position: 'relative' }}>
      {loading ? (
          ...
          <thead className="bg-gray-100 sticky top-0 z-10">
            {headerGroups.map(headerGroup => (
              <tr {...headerGroup.getHeaderGroupProps()}>
                {allowRowsSelect && (
                  <th className="text-sm px-2 sticky top-0 z-10 bg-gray-100">
                ...
                {headerGroup.headers.map(header => (
                  <th
                    className={classNames(
                      'text-sm bg-gray-100', // Ensure background color is set for sticky headers
                      'sticky top-0 z-10', // Ensure sticky position
                    )}
